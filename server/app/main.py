...
from app.routes import emp_leaves_route, emp_details_route, leave_appln_route, holidays_route
...
app.include_router(leave_appln_route.leave_appln_route)
app.include_router(holidays_route.holidays_route)
